...
package fieldTable_pack is

   constant int_n : integer := 255;
   constant int_k : integer := 239;
   constant int_e : integer := 16;
   constant int_t : integer := int_e/2;
   constant int_s : integer := 8;
   
   type rs_vector is array(0 to int_e-1) of std_logic_vector(int_s-1 downto 0);
   type bm_vector is array(0 to int_t-1) of std_logic_vector(int_s-1 downto 0);
   type sy_vector is array(0 to int_t)   of std_logic_vector(int_s-1 downto 0);
...
architecture inv_module of inv_module is

begin

	output <= "00000000" when input="00000000" else
			  "00000001" when input="00000001" else
			  "10001110" when input="00000010" else
