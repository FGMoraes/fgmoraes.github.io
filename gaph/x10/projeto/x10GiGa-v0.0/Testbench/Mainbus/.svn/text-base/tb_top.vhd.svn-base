...
signal entrada    : std_logic_vector(63 downto 0);

signal FWORD    : std_logic_vector(63 downto 0);
--file   FRAME    : TEXT open READ_MODE is "../Simulacao/test_v0_bin00.out";
file   FRAME    : TEXT open READ_MODE is "../Simulacao/frames_bin0000.out";
...
begin
	...
	file_save_output:process
		...
		file   outputDataFile : TEXT open WRITE_MODE is "../Simulacao/output.txt";
	...
	begin
		...
		elsif rising_edge(clk2x_tb) then 
	...
	file_save_input:process
		variable i : POSITIVE := 1;
		file   outputDataFile : TEXT open WRITE_MODE is "../Simulacao/input.txt";
		procedure saveOutputData (data : in std_logic_vector) is
			variable lineAux   : line;
		begin
			write(lineAux,data);
